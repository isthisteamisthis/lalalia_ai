...
now_dir = os.getcwd()
train_dir = os.getcwd() + "\\pyaitrain\\models"
...
weight_root = f"{train_dir}\\weights"
weight_uvr5_root = f"{train_dir}\\uvr5_weights"
index_root = f"{train_dir}\\logs"
names = []
...
def train1key(exp_dir1, trainset_dir4, total_epoch11, gpus16, pretrained_G14, pretrained_D15):
    ...
    sr2 = "40k"  # 샘플링 주파수 설정 : wav 파일에 따라 결정 (44100 : 40K / 48000 이상 : 48K)
