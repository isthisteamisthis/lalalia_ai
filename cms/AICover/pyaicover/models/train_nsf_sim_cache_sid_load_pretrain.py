...
now_dir = os.getcwd()
sys.path.append(os.path.join(now_dir + '/pyaicover/models'))
sys.path.append(os.path.join(now_dir + '/pyaicover/models', "train"))
...
def main():
    ...
    for i in range(n_gpus):
        ...
        print("프로세스 시작")
        subproc.start()  # 프로세스 시작

    for i in range(n_gpus):
        children[i].join()  # 프로세스 종료
        print("프로세스 종료")
